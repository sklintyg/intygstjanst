 ...
 * @author eriklupander
 */
class RelationDaoTest extends TestSupport {
  ...
  private static final List<String> CERTIFICATE_IDS =
      List.of(INTYG_0_1, INTYG_0, INTYG_1, INTYG_2, INTYG_3);
  ...
  void shouldEraseRelationsWhereToOrFromFieldHasCertificateForRemoval() {
    ...
    final var relations =
        entityManager.createQuery("SELECT r.id From Relation r", Long.class).getResultList();
  ...
  private void buildRelationTree() {
    Relation r0 =
        new Relation(
            INTYG_1, INTYG_0, RelationKod.FRLANG.value(), LocalDateTime.now().minusDays(30));
    Relation r1 =
        new Relation(
            INTYG_2, INTYG_1, RelationKod.ERSATT.value(), LocalDateTime.now().minusDays(20));
    Relation r2 =
        new Relation(
            INTYG_3, INTYG_2, RelationKod.FRLANG.value(), LocalDateTime.now().minusDays(10));
    Relation r01 =
        new Relation(
            INTYG_0_1, INTYG_0, RelationKod.KOMPLT.value(), LocalDateTime.now().minusDays(25));
  ...
  private void buildRelationTreeIncludingRevoked() {
    ...
    Relation r001 =
        new Relation(
            INTYG_0, INTYG_0_1, RelationKod.KOMPLT.value(), LocalDateTime.now().minusDays(25));
