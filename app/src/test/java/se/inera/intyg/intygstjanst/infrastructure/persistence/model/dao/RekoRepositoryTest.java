...
class RekoRepositoryTest extends TestSupport {
  ...
  @Autowired private RekoRepository rekoRepository;
  ...
  void shouldFindByPatientIdsAndCareUnitId() {
    ...
    final var actualResult =
        rekoRepository.findByPatientIdInAndCareUnitId(List.of(PATIENT_ID_1), CARE_UNIT_ID_1);
  ...
  private static Reko getReko(
      String patientId, String careUnitId, LocalDateTime sickLeaveTimestamp) {
