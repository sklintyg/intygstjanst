...
class RekoStatusDecoratorTest {
  ...
  @InjectMocks private RekoStatusDecorator rekoStatusDecorator;
  ...
  class TestRekoStatusDecoration {
    ...
    @BeforeEach
    void setup() {
      when(rekoRepository.findByPatientIdInAndCareUnitId(anyList(), anyString()))
