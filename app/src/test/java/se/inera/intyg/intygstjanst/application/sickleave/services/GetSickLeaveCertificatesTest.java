...
class GetSickLeaveCertificatesTest {
  ...
  @InjectMocks private GetSickLeaveCertificates getSickLeaveCertificates;
  ...
  class CareProviderIdTest {
    ...
    void shallIncludeCareProviderIdWhenQueryActiveSjukfallCertificate() {
      ...
      verify(sjukfallCertificateDao)
          .findAllSjukfallCertificate(careProviderIdCaptor.capture(), anyList(), anyList());
  ...
  class UnitIdsTest {
    ...
    void shallIncludeUnitIdsWhenQueryActiveSjukfallCertificate() {
      ...
      getSickLeaveCertificates.get(
          ...
          PROTECTED_PERSON_FILTER_ID);
      verify(sjukfallCertificateDao)
          .findAllSjukfallCertificate(anyString(), unitIdsCaptor.capture(), anyList());
  ...
  class PatientIdsTest {
    ...
    void shallIncludeUnitIdsWhenQueryActiveSjukfallCertificate() {
      ...
      getSickLeaveCertificates.get(
          ...
          PROTECTED_PERSON_FILTER_ID);
      verify(sjukfallCertificateDao)
          .findAllSjukfallCertificate(anyString(), anyList(), patientIdsCaptor.capture());
  ...
  void shallReturnSickLeaves() {
    ...
    final var actualSjukfallEnhetList =
        getSickLeaveCertificates.get(
            CARE_PROVIDER_ID,
            UNIT_IDS,
            PATIENT_IDS,
