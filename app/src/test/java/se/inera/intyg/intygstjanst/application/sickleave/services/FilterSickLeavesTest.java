...
class FilterSickLeavesTest {
  ...
  @Mock private TextSearchFilterService textSearchFilterService;

  @InjectMocks private FilterSickLeaves filterSickLeaves;
  ...
  class FilterOnSickLeaveLength {
    ...
    void shouldFilterOnSickLeaveLengthIfSpecified() {
      final var expectedSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 36, PATIENT_ID, Collections.emptyList());
      final var expectedSickLeaveList = List.of(expectedSickLeave);
      final var anotherSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 42, PATIENT_ID, Collections.emptyList());
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);

      final var actualSickLeaveList =
          filterSickLeaves.filter(
              sickLeaves,
              List.of(
                  new SickLeaveLengthInterval(6, 12),
                  new SickLeaveLengthInterval(12, 40),
                  new SickLeaveLengthInterval(50, 100)),
    ...
    void shouldFilterOnSickLeaveLengthIfFromIsNull() {
      ...
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              List.of(
                  new SickLeaveLengthInterval(6, 12),
                  new SickLeaveLengthInterval(null, 40),
                  new SickLeaveLengthInterval(50, 100)),
              Collections.emptyList(),
              null,
              null,
    ...
    void shouldFilterOnSickLeaveLengthIfToIsNull() {
      ...
      final var expectedSickLeaveList = List.of(expectedSickLeave);
      final var anotherSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 26, PATIENT_ID, Collections.emptyList());
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);
      ...
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              List.of(
                  new SickLeaveLengthInterval(6, 12),
                  new SickLeaveLengthInterval(35, null),
                  new SickLeaveLengthInterval(50, 100)),
              Collections.emptyList(),
              null,
              null,
    ...
    void shouldNotFilterOnSickLeaveLengthIfFromAndToIsNull() {
      ...
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              List.of(
                  new SickLeaveLengthInterval(6, 12),
                  new SickLeaveLengthInterval(null, null),
                  new SickLeaveLengthInterval(50, 100)),
              Collections.emptyList(),
              null,
              null,
    ...
    void shouldNotFilterOnSickLeaveLengthIfNull() {
      final var expectedSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 12, PATIENT_ID, Collections.emptyList());
      final var anotherSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 5, PATIENT_ID, Collections.emptyList());
      final var expectedSickLeaveList = List.of(expectedSickLeave, anotherSickLeave);
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);
  ...
  class FilterOnDiagnosisChapter {
    ...
    void shouldFilterOnDiagnosisChapterIfSpecified() {
      ...
      final var anotherSickLeave =
          createSjukFallEnhet(ANOTHER_DIAGNOSIS_CODE, 12, PATIENT_ID, Collections.emptyList());
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);
    ...
    void shouldNotFilterOnDiagnosisChapterIfNull() {
      final var expectedSickLeave =
          createSjukFallEnhet(DIAGNOSIS_CODE, 12, PATIENT_ID, Collections.emptyList());
      final var anotherSickLeave =
          createSjukFallEnhet(ANOTHER_DIAGNOSIS_CODE, 5, PATIENT_ID, Collections.emptyList());
      final var expectedSickLeaveList = List.of(expectedSickLeave, anotherSickLeave);
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);
  ...
  class FilterOnPatientAge {
    ...
    void shouldFilterOnPatientAgeIfSpecified() {
      ...
      final var anotherSickLeave =
          createSjukFallEnhet(
              ANOTHER_DIAGNOSIS_CODE, 12, ANOTHER_PATIENT_ID, Collections.emptyList());
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);

      doReturn(50).when(calculatePatientAgeService).get(expectedSickLeave.getPatient().getId());

      doReturn(20).when(calculatePatientAgeService).get(anotherSickLeave.getPatient().getId());
    ...
    void shouldNotFilterOnPatientAgeIfFromIsNull() {
      ...
      final var anotherSickLeave =
          createSjukFallEnhet(
              ANOTHER_DIAGNOSIS_CODE, 5, ANOTHER_PATIENT_ID, Collections.emptyList());
      final var expectedSickLeaveList = List.of(expectedSickLeave, anotherSickLeave);
      final var sickLeaves = List.of(expectedSickLeave, anotherSickLeave);
    ...
    void shouldFilterDoctorIdsExcludedInFilter() {
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              null,
              TO_END_DATE,
              Collections.singletonList(doctor1.getId()),
              Collections.emptyList(),
              Collections.emptyList(),
              null);
    ...
    void shouldNotFilterDoctorIdsIncludedInFilter() {
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              null,
              TO_END_DATE,
              List.of(doctor1.getId(), doctor2.getId()),
              Collections.emptyList(),
              Collections.emptyList(),
              null);
  ...
  class FilterOnRekoStatus {
    ...
    void setup() {
      ...
      sickLeaveWithNoRekoStatus =
          createSjukFallEnhet(DIAGNOSIS_CODE, 5, THIRD_PATIENT_ID, Collections.emptyList());
    ...
    void shouldNotFilterRekoStatusIncludedInFilter() {
      final var actualSickLeaveList =
          filterSickLeaves.filter(
              ...
              Collections.emptyList(),
              List.of(
                  RekoStatusType.REKO_1.toString(),
                  RekoStatusType.REKO_2.toString(),
                  RekoStatusType.REKO_3.toString()),
              Collections.emptyList(),
              null);
      ...
      sickLeaves =
          List.of(
              createSjukFallEnhet(
                  ...
                  5,
                  PATIENT_ID,
                  List.of(OCCUPATION_STUDIER, OCCUPATION_FORALDRALEDIGHET)),
              createSjukFallEnhet(
                  DIAGNOSIS_CODE,
                  5,
                  PATIENT_ID,
                  List.of(OCCUPATION_NUVARANDE_ARBETE, OCCUPATION_ARBETSSOKANDE)));
      final var filteredSickLeaves =
          filterSickLeaves.filter(
              sickLeaves, null, null, null, null, null, null, null, null, null, null);
    ...
    void shouldFilterOnNuvarandeArbete() {
      ...
      sickLeaves =
          List.of(
              expectedSickLeave,
              createSjukFallEnhet(
                  DIAGNOSIS_CODE, 5, PATIENT_ID, List.of(OCCUPATION_NUVARANDE_ARBETE)));
      final var filteredSickLeaves =
          filterSickLeaves.filter(
              sickLeaves,
              null,
    ...
    void shouldFilterOnArbetssokande() {
      expectedSickLeave =
          createSjukFallEnhet(
              ...
              PATIENT_ID,
              List.of(
                  OCCUPATION_STUDIER, OCCUPATION_FORALDRALEDIGHET, OCCUPATION_NUVARANDE_ARBETE));
      sickLeaves =
          List.of(
              expectedSickLeave,
              createSjukFallEnhet(
                  DIAGNOSIS_CODE, 5, PATIENT_ID, List.of(OCCUPATION_ARBETSSOKANDE)));
      final var filteredSickLeaves =
          filterSickLeaves.filter(
              sickLeaves,
              null,
    ...
    void shouldFilterOnForaldraledighet() {
      ...
      sickLeaves =
          List.of(
              expectedSickLeave,
              createSjukFallEnhet(
                  DIAGNOSIS_CODE, 5, PATIENT_ID, List.of(OCCUPATION_FORALDRALEDIGHET)));
      final var filteredSickLeaves =
          filterSickLeaves.filter(
              sickLeaves,
              null,
    ...
    void shouldFilterOnStudier() {
      expectedSickLeave =
          createSjukFallEnhet(
              ...
              PATIENT_ID,
              List.of(
                  OCCUPATION_FORALDRALEDIGHET,
                  OCCUPATION_ARBETSSOKANDE,
                  OCCUPATION_NUVARANDE_ARBETE));
      sickLeaves =
          List.of(
              expectedSickLeave,
  ...
  private static SjukfallEnhet createSjukFallEnhet(
      String diagnosisCode, Integer dagar, String patientId, List<String> occupations) {
    SjukfallEnhet sickLeaveUnit = new SjukfallEnhet();
    Lakare lakare = Lakare.create(DOCTOR_ID, null);
    sickLeaveUnit.setLakare(lakare);
    sickLeaveUnit.setVardenhet(Vardenhet.create(UNIT_ID, null));
