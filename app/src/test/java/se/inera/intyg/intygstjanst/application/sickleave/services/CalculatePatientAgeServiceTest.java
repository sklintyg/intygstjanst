...
class CalculatePatientAgeServiceTest {
  ...
  @InjectMocks private CalculatePatientAgeService calculatePatientAgeService;
  ...
  void shouldCalculateAgeForStandardPatientIdWithPlusSeparator() {
    ...
    assertEquals(
        expectedAge.getYears(), calculatePatientAgeService.get(patientIdWithPlusSeparator));
  }
  ...
  void shouldCalculateAgeFor10DigitPatientIdWithoutSeparator() {
    ...
    assertEquals(
        expectedAge.getYears(), calculatePatientAgeService.get(tenDigitPatientIdWithoutSeparator));
  }
