...
class DiagnosisChapterServiceTest {

  @Mock private DiagnosisChapterProvider diagnosisChapterProvider;
  @InjectMocks private DiagnosisChapterService diagnosisChapterService;
  ...
  void setUp()
    ...
    Method postConstruct =
        DiagnosisChapterService.class.getDeclaredMethod("init", (Class<?>[]) null);
  ...
  class GetDiagnosisChapterFromSickLeaveTest {
    ...
    void shouldReturnChapterE() {
      ...
      final var expectedResult =
          new DiagnosKapitel(
              "E00-E90Endokrina sjukdomar, nutritionsrubbningar och ämnesomsättningssjukdomar");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterG() {
      ...
      final var expectedResult = new DiagnosKapitel("G00-G99Sjukdomar i nervsystemet");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnSecondChapterH() {
      ...
      final var expectedResult = new DiagnosKapitel("H60-H95Sjukdomar i örat och mastoidutskottet");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterI() {
      ...
      final var expectedResult = new DiagnosKapitel("I00-I99Cirkulationsorganens sjukdomar");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterJ() {
      ...
      final var expectedResult = new DiagnosKapitel("J00-J99Andningsorganens sjukdomar");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterK() {
      ...
      final var expectedResult = new DiagnosKapitel("K00-K93Matsmältningsorganens sjukdomar");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterL() {
      ...
      final var expectedResult = new DiagnosKapitel("L00-L99Hudens och underhudens sjukdomar");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterN() {
      ...
      final var expectedResult = new DiagnosKapitel("N00-N99Sjukdomar i urin- och könsorganen");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterP() {
      ...
      final var expectedResult = new DiagnosKapitel("P00-P96Vissa perinatala tillstånd");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterU() {
      ...
      final var expectedResult = new DiagnosKapitel("U00-U99Koder för särskilda ändamål");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
    ...
    void shouldReturnChapterV() {
      ...
      final var expectedResult = new DiagnosKapitel("V01-Y98Yttre orsaker till sjukdom och död");
      final var result = diagnosisChapterService.getDiagnosisChaptersFromSickLeave(sjukfallEnhet);
      assertEquals(expectedResult, result);
    }
  ...
  private List<DiagnosKapitel> getChapters() {
    return List.of(
        ...
        new DiagnosKapitel(
            "D50-D89Sjukdomar i blod och blodbildande organ samt vissa rubbningar i immunsystemet"),
        new DiagnosKapitel(
            "E00-E90Endokrina sjukdomar, nutritionsrubbningar och ämnesomsättningssjukdomar"),
        new DiagnosKapitel("F00-F99Psykiska sjukdomar och syndrom samt beteendestörningar"),
