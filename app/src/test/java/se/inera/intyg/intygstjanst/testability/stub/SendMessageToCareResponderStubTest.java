...
class SendMessageToCareResponderStubTest {
  ...
  @InjectMocks private SendMessageToCareResponderStub stub;

  @Spy private SendMessageToCareStorage storage;

  @Test
  void testSendMessageToCareResponderStub() throws Exception {
    String logicalAddress = "";
    SendMessageToCareType sendMessageToCareType1 =
        buildSendMessageToCare(intygsIdNo1, meddelandeIdNo1);
  ...
  void testSendMultipleMessagesToCareResponderStubAndThenClear() throws Exception {
    ...
    SendMessageToCareType sendMessageToCareType1 =
        buildSendMessageToCare(intygsIdNo1, meddelandeIdNo1);
    SendMessageToCareType sendMessageToCareType2 =
        buildSendMessageToCare(intygsIdNo1, meddelandeIdNo2);
    SendMessageToCareType sendMessageToCareType3 =
        buildSendMessageToCare(intygsIdNo2, meddelandeIdNo3);
  ...
  private SendMessageToCareType buildSendMessageToCare(String intygsId, String meddelandeId)
      throws Exception {
