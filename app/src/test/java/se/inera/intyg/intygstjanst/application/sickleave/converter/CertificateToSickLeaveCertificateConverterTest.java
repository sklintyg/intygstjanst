...
class CertificateToSickLeaveCertificateConverterTest {
  ...
  void convertAg7804() {
    ...
    var sickLeaveCertificate =
        (new CertificateToSickLeaveCertificateConverter()).convertAg7804(certificate, statement);
  ...
  void convertAg114() {
    ...
    var sickLeaveCertificate =
        (new CertificateToSickLeaveCertificateConverter()).convertAg114(certificate, statement);
  ...
  private ImmutableList<se.inera.intyg.common.ag114.v1.model.internal.Sysselsattning>
      getSysselsattningAg114() {
    var occupation =
        se.inera.intyg.common.ag114.v1.model.internal.Sysselsattning.create(
            SysselsattningsTyp.NUVARANDE_ARBETE);
    ...
    return ImmutableList.copyOf(
        new Sjukskrivning[] {
          Sjukskrivning.create(
              ...
              new InternalLocalDateInterval(START_DATE_100, END_DATE_100)),
          Sjukskrivning.create(
              SjukskrivningsGrad.NEDSATT_3_4,
              new InternalLocalDateInterval(START_DATE_75, END_DATE_75)),
          Sjukskrivning.create(
              SjukskrivningsGrad.NEDSATT_HALFTEN,
              new InternalLocalDateInterval(START_DATE_50, END_DATE_50)),
          Sjukskrivning.create(
              SjukskrivningsGrad.NEDSATT_1_4,
              new InternalLocalDateInterval(START_DATE_25, END_DATE_25))
        });
  }

  private ImmutableList<se.inera.intyg.common.ag7804.model.internal.Sysselsattning>
      getOccupationAg7804() {
    var occupation =
        se.inera.intyg.common.ag7804.model.internal.Sysselsattning.create(
            se.inera.intyg.common.ag7804.model.internal.Sysselsattning.SysselsattningsTyp
                .NUVARANDE_ARBETE);
    return ImmutableList.copyOf(
        new se.inera.intyg.common.ag7804.model.internal.Sysselsattning[] {occupation});
  }
