...
class TestCertificateServiceTest {
  ...
  @Mock private RelationDao relationDao;
  ...
  private static final LocalDateTime FROM = LocalDateTime.of(2020, 4, 1, 0, 0);
  ...
  void setupTestCertificates() throws Exception {
    ...
    lenient()
        .doReturn(testCertificateRoot)
        .when(certificateDao)
        .getCertificate(null, TEST_CERTIFICATE_ROOT_ID);
    ...
    lenient()
        ...
        .when(certificateDao)
        .getCertificate(null, TEST_CERTIFICATE_BRANCH_ID);
    ...
    lenient()
        .doReturn(testCertificateLeaf)
        .when(certificateDao)
        .getCertificate(null, TEST_CERTIFICATE_LEAF_ID);
    ...
    lenient()
        ...
        .when(certificateDao)
        .getCertificate(null, TEST_CERTIFICATE_SINGLE_ID);
  }
