...
public class SjukfallCertTestHelper {
  ...
  public SjukfallCertificate buildSjukfallCertificate(
      String careGiverId, String careUnitId, String careUnitName) {
    return buildSjukfallCertificate(
        careGiverId, careUnitId, careUnitName, defaultWorkCapacities(), false);
  }
