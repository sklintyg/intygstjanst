...
public final class CertificateFactory {
  ...
  public static final Personnummer CIVIC_REGISTRATION_NUMBER =
      Personnummer.createPersonnummer("19001122-3344").get();
  ...
  public static Certificate buildCertificate(
      String certificateId, String certificateType, String certificateTypeVersion) {
    return buildCertificate(
        certificateId, certificateType, certificateTypeVersion, VALID_FROM, VALID_TO);
  }
