...
import se.inera.intyg.intygstjanst.infrastructure.csintegration.dto.GetCitizenCertificatesResponse;
...
import se.inera.intyg.intygstjanst.infrastructure.csintegration.dto.GetValidSickLeaveCertificateIdsInternalResponse;
import se.inera.intyg.intygstjanst.infrastructure.csintegration.dto.SendCitizenCertificateRequestDTO;
import se.inera.intyg.intygstjanst.infrastructure.csintegration.dto.SendCitizenCertificateResponseDTO;
...
class CSIntegrationServiceTest {
  ...
  class GetCertificateCountForPrivatePractitionerTests {
    ...
    void setUp() {
      ...
      when(restClient.post()).thenReturn(requestBodyUriSpec);
      when(requestBodyUriSpec.uri("/internalapi/certificate/issuedBy"))
          .thenReturn(requestBodyUriSpec);
      when(requestBodyUriSpec.header(LOG_TRACE_ID_HEADER, "traceId"))
          .thenReturn(requestBodyUriSpec);
      when(requestBodyUriSpec.header(LOG_SESSION_ID_HEADER, "sessionId"))
