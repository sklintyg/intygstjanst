...
package se.inera.intyg.intygstjanst.support;
...
public class CertificateForSjukfallFactory {
  ...
  public Fk7263Utlatande buildFk7263Utlatande() {
    ...
    when(utlatande.getNedsattMed100())
        .thenReturn(new InternalLocalDateInterval(START_DATE_100, END_DATE_100));
    when(utlatande.getNedsattMed75())
        .thenReturn(new InternalLocalDateInterval(START_DATE_75, END_DATE_75));
    when(utlatande.getNedsattMed50())
        .thenReturn(new InternalLocalDateInterval(START_DATE_50, END_DATE_50));
    when(utlatande.getNedsattMed25())
        .thenReturn(new InternalLocalDateInterval(START_DATE_25, END_DATE_25));
  ...
  public LisjpUtlatandeV1 buildLisjpUtlatande() {
    ...
    when(utlatande.getSjukskrivningar())
        .thenReturn(
            ImmutableList.of(
