...
/**
 * Class for consuming JMS messages sent to statistik (ST). Meant to be used for integration testing
 * purposes.
 */
@Component
          ...
          try {
            ...
            final String id =
                msg.getStringProperty(
                    FK_MESSAGE_ACTION.equals(action) ? MESSAGE_ID : CERTIFICATE_ID);
