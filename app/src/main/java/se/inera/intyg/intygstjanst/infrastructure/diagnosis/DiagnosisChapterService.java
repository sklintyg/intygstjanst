...
public class DiagnosisChapterService {
  ...
  @Autowired private DiagnosisChapterProvider diagnosisChapterProvider;
  ...
  public DiagnosKapitel getDiagnosisChaptersFromSickLeave(SjukfallEnhet sickLeave) {
    final var diagnosisCategory =
        DiagnosKategori.extractFromString(sickLeave.getDiagnosKod().getCleanedCode());
