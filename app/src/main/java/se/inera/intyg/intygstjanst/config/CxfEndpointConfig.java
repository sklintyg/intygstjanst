...
public class CxfEndpointConfig {
    ...
    @Bean
    public Endpoint getRecipientsForCertificateEndpoint(GetRecipientsForCertificateResponderInterface implementor) {
    ...
    @Bean
    public Endpoint listRelationsForCertificateEndpoint(ListRelationsForCertificateResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
        endpoint.publish("/list-relations-for-certificate/v1.0");
        endpoint.setSchemaLocations(List.of(
            SCHEMA_CP_3_3, SCHEMA_INTYG_TYPES_3_2, SCHEMA_CP_3_2_EXT, SCHEMA_CP_3_4_EXT,
            SCHEMA_XMLDSIG, SCHEMA_XMLDSIG_FILTER,
    ...
    @Bean
    public Endpoint getCertificateTypeInfoEndpoint(GetCertificateTypeInfoResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    public Endpoint listCertificatesEndpoint(ListCertificatesResponderInterface implementor) {
        ...
        endpoint.getOutFaultInterceptors().add(
            new SoapFaultToSoapResponseTransformerInterceptor("transform/list-certificates-transform.xslt"));
        return endpoint;
    }

    @Bean
    public Endpoint revokeMedicalCertificateEndpoint(RevokeMedicalCertificateResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
        endpoint.publish("/revoke-certificate/v1.0");
        endpoint.getOutFaultInterceptors().add(
            new SoapFaultToSoapResponseTransformerInterceptor("transform/revoke-medical-certificate-transform.xslt"));
        return endpoint;
    }
    ...
    public Endpoint revokeCertificateEndpoint(
        ...
        endpoint.setSchemaLocations(List.of(
            SCHEMA_CP_3_3, SCHEMA_CP_TYPES_3_2, SCHEMA_CP_3_2_EXT, SCHEMA_CP_3_4_EXT,
            SCHEMA_XMLDSIG, SCHEMA_XMLDSIG_FILTER,
    ...
    @Bean
    public Endpoint sendMedicalCertificateEndpoint(SendMedicalCertificateResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
        endpoint.publish("/send-certificate/v1.0");
        endpoint.getOutFaultInterceptors().add(
            new SoapFaultToSoapResponseTransformerInterceptor("transform/send-medical-certificate-transform.xslt"));
        return endpoint;
    }

    @Bean
    public Endpoint sendCertificateToRecipientEndpoint(SendCertificateToRecipientResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    public Endpoint setCertificateStatusEndpoint(
        @Qualifier("setCertificateStatusResponderV1") se.inera.ifv.insuranceprocess.healthreporting.setcertificatestatus.rivtabp20.v1.SetCertificateStatusResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
        endpoint.publish("/set-certificate-status/v1.0");
        endpoint.getOutFaultInterceptors().add(
            new SoapFaultToSoapResponseTransformerInterceptor("transform/set-certificate-status-transform.xslt"));
        return endpoint;
    }
    ...
    public Endpoint getCertificateV2Endpoint(GetCertificateResponderInterface implementor) {
        // No outFaultInterceptors — we want a SOAPFault when the certificate does not exist. See INTYG-2126.
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    public Endpoint listCertificatesForCitizenV3Endpoint(
        @Qualifier("ListCertificatesForCitizenResponderImplV3") se.riv.clinicalprocess.healthcond.certificate.listCertificatesForCitizen.v3.ListCertificatesForCitizenResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    public Endpoint listCertificatesForCitizenV4Endpoint(
        @Qualifier("listCertificatesForCitizenResponderImpl") se.riv.clinicalprocess.healthcond.certificate.listCertificatesForCitizen.v4.ListCertificatesForCitizenResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listCertificatesForCareV3Endpoint(ListCertificatesForCareResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    public Endpoint setCertificateStatusV2Endpoint(
        @Qualifier("setCertificateStatusResponderImplV2") se.riv.clinicalprocess.healthcond.certificate.setCertificateStatus.v2.SetCertificateStatusResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listApprovedReceiversEndpoint(ListApprovedReceiversResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listPossibleReceiversEndpoint(ListPossibleReceiversResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint registerApprovedReceiversEndpoint(RegisterApprovedReceiversResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listActiveSickLeavesForCareUnitEndpoint(ListActiveSickLeavesForCareUnitResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listSickLeavesForPersonEndpoint(ListSickLeavesForPersonResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
    ...
    @Bean
    public Endpoint listSickLeavesForCareEndpoint(ListSickLeavesForCareResponderInterface implementor) {
        final var endpoint = new EndpointImpl(bus, implementor);
