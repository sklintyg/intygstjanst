...
public class TsDiabetesItCxfConfig {
  ...
  @Bean
  public GetTSDiabetesResponderInterface getTSDiabetesResponder(
      ModuleContainerApi moduleContainer) {
    return new GetTSDiabetesResponderImpl(moduleContainer);
  }

  @Bean
  public RegisterTSDiabetesResponderInterface registerTSDiabetesResponder(
      ModuleContainerApi moduleContainer) {
  ...
  /**
   * Creates the {@code tsDiabetesXslTransformer} bean used for XSLT transformation of ts-diabetes
   * XML.
   *
   * <p>Equivalent XML:
   *
  ...
  /**
   * Creates the {@code sendTsDiabetesClient} — a {@link RegisterCertificateV1Client} pointing at
