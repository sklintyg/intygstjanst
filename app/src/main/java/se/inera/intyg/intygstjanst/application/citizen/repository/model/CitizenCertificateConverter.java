...
public class CitizenCertificateConverter {
  ...
  public CitizenCertificateConverter(
  ...
  private List<CitizenCertificateRelationDTO> getRelations(
      String certificateId, List<Relation> relations) {
  ...
  private Optional<CertificateStateHistoryEntry> getSentState(
      Collection<CertificateStateHistoryEntry> states) {
