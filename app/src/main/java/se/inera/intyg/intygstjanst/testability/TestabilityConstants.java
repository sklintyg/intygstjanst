...
public class TestabilityConstants {
  ...
  public static final String ALFA_FYSIOLOGISKAMOTTAGNINGEN_UNIT_NAME =
  ...
  public static final String ALFA_MEDICINCENTRUM_INFEKTIONSMOTTAGNINGEN_UNIT_NAME =
      "Alfa Infektionsmottagningen";
  ...
  public static final String
      ALFA_PSYKIATRICENTRUM_ALFA_BARN_OCH_UNGDOMS_PSYOKOLOGISKA_MOTTAGNINGEN =
          "TSTNMT2321000156-ALBM";
  public static final String
      ALFA_PSYKIATRICENTRUM_ALFA_BARN_OCH_UNGDOMS_PSYOKOLOGISKA_MOTTAGNINGEN_UNIT_NAME =
          "Alfa Barn och Ungdoms Psykologiska-mottagning";
  public static final String ALFA_PSYKIATRICENTRUM_PSYKOLOGISKAMOTTAGNINGEN =
      "TSTNMT2321000156-ALPM";
  public static final String ALFA_PSYKIATRICENTRUM_PSYKOLOGISKAMOTTAGNINGEN_UNIT_NAME =
      "Alfa Psykologiskamottagningen";
  ...
  public static final String ALFA_VARDCENTRAL_LAKARMOTTAGNINGEN_UNIT_NAME =
      "Alfa Läkarmottagningen";
  ...
  public static final String BETA_HJARTCENTRUM_FYSIOLOGISKAMOTTAGNINGEN_UNIT_NAME =
      "Beta Fysiologiskamottagningen";
  ...
  public static final String BETA_MEDICINCENTRUM_ALLERGIMOTTAGNINGEN_UNIT_NAME =
      "Beta Allergimottagningen";
  ...
  public static final String BETA_MEDICINCENTRUM_INFEKTIONSMOTTAGNINGEN_UNIT_NAME =
      "Beta Infektionsmottagningen";
  ...
  public static final String
      BETA_PSYKIATRICENTRUM_ALFA_BARN_OCH_UNGDOMS_PSYOKOLOGISKA_MOTTAGNINGEN =
          "TSTNMT2321000156-BEBM";
  public static final String
      BETA_PSYKIATRICENTRUM_ALFA_BARN_OCH_UNGDOMS_PSYOKOLOGISKA_MOTTAGNINGEN_UNIT_NAME =
          "Beta Barn och Ungdoms Psykologiska-mottagning";
  public static final String BETA_PSYKIATRICENTRUM_PSYKOLOGISKAMOTTAGNINGEN =
      "TSTNMT2321000156-BEPM";
  public static final String BETA_PSYKIATRICENTRUM_PSYKOLOGISKAMOTTAGNINGEN_UNIT_NAME =
      "Beta Psykologiskamottagningen";
  ...
  public static final String BETA_VARDCENTRAL_LAKARMOTTAGNINGEN_UNIT_NAME =
      "Beta Läkarmottagningen";
  // WORK CAPACITIES
