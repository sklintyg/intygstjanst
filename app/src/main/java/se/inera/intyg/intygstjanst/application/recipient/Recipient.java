...
public class Recipient {
   ...
   * @param certificateTypes a comma-separated string of the type of certificates this recipient
   *     support
   * @param active if the recipient is active
   * @param trusted if the recipient can be trusted with information about sekretessmarkerade
   *     patients
   */
  public Recipient(
  ...
  public String toString() {
    return "logicalAddress: "
        ...
        + recipientType.name()
        + " certificateTypes: "
        + Joiner.on(SEPARATOR).join(certificateTypes)
        + " active: "
        + active
        + " trusted: "
        + trusted;
