...
public class SendCertificateToRecipientResponderImpl
    implements SendCertificateToRecipientResponderInterface {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(SendCertificateToRecipientResponderImpl.class);
  ...
  public SendCertificateToRecipientResponseType sendCertificateToRecipient(
    ...
    try {
      ...
      LOGGER.error(
          ...
          intygsId,
          personnummer.map(value -> hashUtility.hash(value.getPersonnummer())).orElse(null));
      response.setResult(
