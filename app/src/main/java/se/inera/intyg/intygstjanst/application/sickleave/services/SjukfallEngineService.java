...
import se.inera.intyg.intygstjanst.application.sickleave.dto.SjukfallPatient;
...
import se.inera.intyg.intygstjanst.application.sickleave.engine.SjukfallIntygEnhetCreator;
import se.inera.intyg.intygstjanst.application.sickleave.engine.SjukfallIntygEnhetResolver;
import se.inera.intyg.intygstjanst.application.sickleave.engine.SjukfallIntygPatientCreator;
import se.inera.intyg.intygstjanst.application.sickleave.engine.SjukfallIntygPatientResolver;
import se.inera.intyg.intygstjanst.application.sickleave.engine.SjukfallLangdCalculator;

/**
 * @author Magnus Ekstrand on 2017-02-10.
 */
@Service("sjukfallEngineService")
public class SjukfallEngineService {

  private static final Logger LOG = LoggerFactory.getLogger(SjukfallEngineService.class);
