...
class GetBinaryCertificateWebcertClientTest {
  ...
  void setUp() {
    ...
    client = new GetBinaryCertificateWebcertClient(restClient, new WebcertProperties(BASE_URL, ENDPOINT));
  }
  ...
  void shouldThrowWebcertClientExceptionWhenServerReturnsErrorStatus() {
    ...
    final var exception =
        assertThrows(WebcertClientException.class, () -> client.get(CERT_ID));
