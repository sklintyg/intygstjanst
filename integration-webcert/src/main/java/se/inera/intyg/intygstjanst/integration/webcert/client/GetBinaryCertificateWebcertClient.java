...
@Service
public class GetBinaryCertificateWebcertClient {

  private final RestClient webcertRestClient;
  private final WebcertProperties properties;

  public GetBinaryCertificateWebcertClient(
      @Qualifier("binaryCertificateWebcertRestClient") RestClient webcertRestClient,
      WebcertProperties properties) {
    this.webcertRestClient = webcertRestClient;
