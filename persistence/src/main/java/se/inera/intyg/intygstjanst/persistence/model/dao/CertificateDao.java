...
public interface CertificateDao {
     ...
     *            Type of certificate
     * @param fromDate
     *            From date when the certificate is valid
     * @param toDate
     *            To data when the certificate is valid
     ...
     *
     * @param civicRegistrationNumber
     *            the user's civic registration number or null, if no check for civic registration number is desired
     * @param certificateId
     ...
     *         civic registration number
     *
     * @throws se.inera.intyg.intygstjanst.persistence.exception.PersistenceException
     *             if the given civic registration number does not match with
     ...
     * @param civicRegistrationNumber
     *            the civic registration number of the patient associated to the certificate
     * @param state
     *            the state of the certificate
     * @param target
     *            the target associated with the status update (e.g. Försäkringskassan)
     * @param timestamp
     *            the timestamp of the status update
     * @throws se.inera.intyg.intygstjanst.persistence.exception.PersistenceException
     *             if the combination of certificate ID and civic registration number
     *             does not match
     */
