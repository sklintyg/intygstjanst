...
public class ConvertCertificateXMLToJSONProcessorTest {
	...
	public void testProcessorWithCert() throws Exception {
		...
		Certificate inCert = createCert();

		Certificate outCert = processor.convertAndUpdateCertificate(inCert);

		assertNotNull(outCert.getCertificateJsonAsString());
    ...
    public void testProcessorWith404() throws Exception {
        ...
        processor.convertAndUpdateCertificate(inCert);        
    }
	...
	private Certificate createCert() throws IOException {
		...
		cert.setCertificateXml(FileUtils.readFileToByteArray(fileRes
				.getFile()));
