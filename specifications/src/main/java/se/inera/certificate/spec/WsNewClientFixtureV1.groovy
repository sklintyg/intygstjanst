...
class WsNewClientFixtureV1 {
	...
	public WsNewClientFixtureV1() {
		this(LOGICAL_ADDRESS)
	}
	
	public WsNewClientFixtureV1(String address) {
	...
	def setClientCertificate(def responder) {
		...
		trustStore.load(WsNewClientFixtureV1.class.getResourceAsStream("/truststore-ntjp.jks"), trustpass.toCharArray());
		...
		certStore.load(WsNewClientFixtureV1.class.getResourceAsStream(certFile), certPass.toCharArray());
