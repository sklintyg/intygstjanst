...
class TransformeraOchJamforIntyg extends WsClientFixture {
    ...
    public void execute() {
        ...
        Marshaller marshaller = JAXBContext.newInstance(se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType).createMarshaller();
        ...
        Unmarshaller unmarshallerNewSchema = JAXBContext.newInstance(se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType.class).createUnmarshaller();
        se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType registerRequestNewSchema = unmarshallerNewSchema.unmarshal(new StreamSource(new FileInputStream (xmlRegisterFile)),
                se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType.class).getValue()
        ...
        try {
            ...
            se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType newRegister =
            ...
            JAXBElement<se.inera.certificate.clinicalprocess.healthcond.certificate.registerMedicalCertificate.v1.RegisterMedicalCertificateType> jaxbObject =
               objectFactory.createRegisterMedicalCertificate(newRegister)
