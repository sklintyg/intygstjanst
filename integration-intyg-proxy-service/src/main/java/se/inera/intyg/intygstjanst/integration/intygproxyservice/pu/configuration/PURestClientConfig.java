 ...
 */
package se.inera.intyg.intygstjanst.integration.intygproxyservice.pu.configuration;
...
public class PURestClientConfig {
  ...
  public RestClient ipsRestClient(RestClient.Builder restClientBuilder) {
