package se.inera.intyg.intygstjanst.integration.intygproxyservice.pu.service;
...
import se.inera.intyg.intygstjanst.integration.intygproxyservice.pu.client.GetPersonsIntygProxyServiceClient;
...
class GetPersonsIntegrationServiceTest {
    ...
    void shallReturnMapWithPersonSvarFound() {
        ...
        final var personIds = List.of(
            personalIdentityNumber1,
            personalIdentityNumber2,
        ...
        doReturn(personsResponse).when(getPersonsIntygProxyServiceClient).get(
