...
public class IntygInfoResponse {
    ...
    public LocalDateTime getReceivedByRecipient() {
        return receivedByRecipient;
    }

    public void setReceivedByRecipient(LocalDateTime receivedByRecipient) {
        this.receivedByRecipient = receivedByRecipient;
    }
    ...
    public void setHistory(List<IntygInfoHistory> history) {
