...
public class PopulateFilterServiceImpl implements PopulateFilterService {
    ...
    public PopulateFilterServiceImpl(SjukfallCertificateDao sjukfallCertificateDao, GetDoctorsFromSickLeaves getDoctorsFromSickLeaves,
        ...
        this.getDoctorsFromSickLeaves = getDoctorsFromSickLeaves;
    ...
    private List<SjukfallCertificate> filterOnUnitIdIfProvidedAndTestCertificate(List<SjukfallCertificate> sickLeaveCertificates,
        String unitId) {
