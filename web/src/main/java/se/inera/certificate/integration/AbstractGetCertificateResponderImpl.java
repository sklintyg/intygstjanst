...
public abstract class AbstractGetCertificateResponderImpl {
    ...
    protected CertificateOrResultType getCertificateForCitizen(String certificateId, String personnummer) {
        if (certificateId == null || certificateId.length() == 0) {
            ...
            return new CertificateOrResultType(ResultTypeUtil.errorResult(VALIDATION_ERROR, "Validation error: missing  certificateId"));
        }
        ...
        if (personnummer == null || personnummer.length() == 0) {
            ...
            return new CertificateOrResultType(ResultTypeUtil.errorResult(VALIDATION_ERROR, "Validation error: missing  personnummer"));
        }
        ...
        try {
            ...
            return new CertificateOrResultType((ResultTypeUtil.errorResult(REVOKED, "Certificate '" + certificateId + "' has been revoked")));
        }
    }
