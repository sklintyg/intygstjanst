...
public class ListApprovedReceiversResponderImplTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testFailsWithUnknownIntygTyp() {
        testee.listApprovedReceivers(LOGICAL_ADDRESS, buildReq(INTYG_ID, "okand-typ"));
    }
    ...
    private Recipient buildRecipient(String recipientId, String certTypes) {
        return new Recipient(LOGICAL_ADDRESS, recipientId + "-name", recipientId, certTypes, true, true);
    }
